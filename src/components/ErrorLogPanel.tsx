    ...
    <>
      <div className={`w-full border-y backdrop-blur-md overflow-hidden transition-all duration-500 ${
        systemLogs 
          ...
          : (isDark ? 'border-white/5 bg-black/30 hover:border-white/10' : 'border-amber-200/40 bg-[#FFFDF9]/60 hover:border-amber-300')
      }`}>
        <div 
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            {isExpanded ? (
              <ChevronUp className={`w-3.5 h-3.5 transition-colors ${isDark ? 'text-white/40 group-hover:text-white' : 'text-[#5C4033] group-hover:text-[#3E2723]'}`} />
            ) : (
              <ChevronDown className={`w-3.5 h-3.5 transition-colors ${isDark ? 'text-white/40 group-hover:text-white' : 'text-[#5C4033] group-hover:text-[#3E2723]'}`} />
            )}
          </div>
        </div>
                ...
                <div className="flex justify-end gap-1 mb-2">
                  ...
                  <button
                    ...
                    className={`p-1 rounded transition-colors ${
                      isDark ? 'text-white/40 hover:text-white hover:bg-white/10' : 'text-[#5C4033] hover:text-[#3E2723] hover:bg-amber-100'
                    }`}
                    title="Phóng to"
                  >
          ...
          >
            <motion.div
              ...
              className={`w-full max-w-4xl max-h-full flex flex-col rounded-2xl border shadow-2xl overflow-hidden ${
                isDark ? 'border-white/10 bg-black/90' : 'border-red-200 bg-[#FFFDFB]'
              }`}
            >
