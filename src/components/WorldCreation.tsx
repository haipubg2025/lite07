        ...
        <div className="w-full flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={saveMenuRef}>
                <motion.button
                  ...
                  className={`p-2.5 rounded-xl border transition-all shadow-md cursor-pointer flex items-center gap-1 ${
                    theme.group === 'Dark' 
                      ...
                      : 'border-amber-200 bg-[#FFFDFB] text-[#5C4033] hover:bg-amber-100'
                  }`}
                  title="Dữ liệu"
                >
                  <Save size={20} />
                    ...
                    <motion.div
                      ...
                      className={`absolute top-full left-0 mt-2 w-48 rounded-xl border shadow-2xl overflow-hidden z-50 ${
                        theme.group === 'Dark' 
                          ...
                          : 'border-amber-200 bg-[#FFFDFB] text-[#5C4033]'
                      }`}
                    >
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 text-sm transition-colors text-left ${
                          theme.group === 'Dark' 
                            ...
                            : 'text-[#5C4033] hover:text-[#3E2723] hover:bg-amber-100'
                        }`}
                      >
                        <Download size={16} />
                        Lưu vào máy tính
                      </button>
                      <div className={`h-[1px] w-full ${theme.group === 'Dark' ? 'bg-white/10' : 'bg-amber-200'}`} />
                      <button
               ...
               <div className={`flex rounded-xl border p-1 ${theme.group === 'Dark' ? 'bg-white/5 border-white/10' : 'bg-[#FFFDFB] border-amber-200 shadow-sm'}`}>
                 <button 
                   onClick={scrollToTop}
                   className={`p-1.5 rounded-lg transition-all cursor-pointer ${theme.group === 'Dark' ? 'text-white/70 hover:text-white hover:bg-white/10' : 'text-[#5C4033] hover:text-[#3E2723] hover:bg-amber-100'}`}
                   title="Lên trên"
                 >
                   <ChevronUp size={18} />
                 </button>
          ...
          {/* Navigation Tabs Row */}
          <div className={`flex p-1 rounded-xl border backdrop-blur-md overflow-x-auto no-scrollbar scrollbar-hide w-fit ${theme.group === 'Dark' ? 'bg-white/5 border-white/10' : 'bg-[#FFFDFB] border-amber-200 shadow-xs'}`}>
            {tabs.map((tab) => {
                ...
                >
                  {isActive && (
                    <motion.div
                      ...
                      className={`absolute inset-0 rounded-lg md:rounded-xl ${isDark ? 'bg-white/20 border border-white/10 shadow-lg shadow-white/5' : 'bg-amber-600 border border-amber-700 shadow-md shadow-amber-500/10'}`}
