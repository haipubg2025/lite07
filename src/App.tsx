          ...
          <Route path="/" element={
            ...
            >
              {isMobile && isMobileMenuOpen ? (
                <div className="w-full h-full flex flex-col items-center justify-center text-center" style={{ backgroundColor: isDark ? 'rgba(0,0,0,0.6)' : 'rgba(92,64,51,0.06)' }}>
                  <div className={`opacity-15 animate-pulse text-xs lg:text-sm tracking-[0.4em] font-extrabold select-none ${isDark ? 'text-white' : 'text-[#3E2723]'}`}>
                    MATRIX LITE v2
                  </div>
                </div>
              ) : (
